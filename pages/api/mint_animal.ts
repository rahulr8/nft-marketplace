...
export default function mint(req: NextApiRequest, res: NextApiResponse): Promise<any> {
  ...
  const nft = ThirdwebSDK.fromPrivateKey(
    '6f7a6eca74cc5451399a098636088520f07c76b5ff0fbd3c0c05a095d2c7da1f',
    'rinkeby'
  ).getNFTCollection('0x572f96AE65938A2F5B234143d7F8bcE0e2B94FBb');
  ...
  return new Promise<void>((resolve) => {
    ...
    nft
      .mintTo(address, {
        name: 'A brand new animal',
        description: 'This animal was minted programatically',
        image:
